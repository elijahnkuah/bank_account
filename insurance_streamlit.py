...
#@st.cache
st.header("Predicting model to determine if a building will have an insurance claim")
...
customer_id = test.Customer Id.values
...
prediction_df = pd.DataFrame(prob1, columns=['Predict'])
